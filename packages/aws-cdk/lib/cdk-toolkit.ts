...
export class CdkToolkit {
   ...
   */
  public async bootstrap(environmentSpecs: string[], bootstrapper: Bootstrapper, options: BootstrapEnvironmentOptions,
    nonCli?: boolean, cdkOutputPath?: string): Promise<any> {
